...
class FaissIvfSqAnnSearcher final : public AnnSearcher {
 public:
  explicit FaissIvfSqAnnSearcher(const IndexMeta& meta);
  ~FaissIvfSqAnnSearcher() override;

  T_FORBID_MOVE(FaissIvfSqAnnSearcher);
  T_FORBID_COPY_AND_ASSIGN(FaissIvfSqAnnSearcher);
