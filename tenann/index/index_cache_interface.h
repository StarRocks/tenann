...
// Lifetime: IndexCacheHandle must be destroyed before the IndexCacheInterface
...
// Global injection — BE calls SetGlobalIndexCache() exactly once at boot.
// tenann internals call GetGlobalIndexCache() and T_CHECK non-null at use site.
