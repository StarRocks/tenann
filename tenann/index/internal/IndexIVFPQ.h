...
struct IndexIVFPQ : IndexIVF {
  ...
  void encode_vectors(idx_t n, const float* x, const idx_t* list_nos, uint8_t* codes,
  ...
  void add_core_o(idx_t n, const float* x, const idx_t* xids, float* residuals_2,
   ...
   */
  void encode_multiple(size_t n, idx_t* keys, const float* x, uint8_t* codes,
